...
List<ServicesModel> servicesList = [
  ...
  ServicesModel(icon: 'assets/images/car-wash_2052428.png', title: 'Casino'),
  ServicesModel(
      icon: 'assets/images/seat_2052451.png', title: 'Exterior Washing'),
  ServicesModel(
      icon: 'assets/images/polish_2052443.png', title: 'Oil Changing'),
  ServicesModel(icon: 'assets/images/tire_2052454.png', title: 'Tire Wash'),
  ServicesModel(icon: 'assets/images/tire_2052455.png', title: 'Car Wash'),
  ServicesModel(
      icon: 'assets/images/vacuum-cleaner_2052459.png', title: 'Detailing'),
  ServicesModel(
      icon: 'assets/images/air-blower_2052425.png', title: 'Car Care'),
  ServicesModel(icon: 'assets/images/car-service.png', title: 'Car Wash'),
  ServicesModel(icon: 'assets/images/car-servicesl.png', title: 'Car Wash'),
];
